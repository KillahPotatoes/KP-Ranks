/*
    ...
    Parameter(s):
        0: ARRAY - Array of player UID and actual name, e.g [Steam UID, Name]
...
private _index = KPR_players findIf {_x select 0 == _update select 0};
KPR_players select _index set [1, _update select 1];
